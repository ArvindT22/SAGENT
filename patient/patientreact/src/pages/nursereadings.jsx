...
import Appbarnursereadings from "../components/appbarnursereadings";

export default function Nursereadings() {
  ...
  const redirectNurseInjection = () => {
    navigate('/nurseinjection', { state: { doctorId, patientId: patientId, username, nurseId } });
  };
                    ...
                    <nav className="navbar navbar-expand-lg navbar-light bg-light">
                      ...
                      <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                          ...
                          <li>
                            <a className="navbar-brand">Readings</a>
                          </li>
                        </ul>
                      </div>
                    </nav>
